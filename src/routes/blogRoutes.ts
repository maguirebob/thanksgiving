...
router.post('/events/:eventId/blog-posts', requireAuth, createEventBlogPost);

// Get a single blog post by ID
router.get('/blog-posts/:blogPostId', getBlogPost);

// Update a blog post by ID
router.put('/blog-posts/:blogPostId', requireAuth, updateBlogPost);

// Delete a blog post by ID
router.delete('/blog-posts/:blogPostId', requireAuth, deleteBlogPost);

...
export const SCHEMA_VERSIONS: Record<string, SchemaVersion> = {
  ...
  '3.1.4': {
    ...
    optionalColumns: {},
    migrationStatus: 'complete',
    notes: 'Documentation release: Added critical git filter-branch warning to project conventions. Restored README.md and DAILY_SESSION_LOG.md with current project information. No database changes, documentation and safety improvements only.'
  },
  '3.1.5': {
    version: '3.1.5',
    requiredTables: [
    ...
    optionalColumns: {},
    migrationStatus: 'complete',
    notes: 'Bug fix release: Fixed TypeScript compilation errors in emailService.ts by removing unused imports and variables. Build now passes successfully for deployment. No database changes, code quality improvements only.'
  }
};

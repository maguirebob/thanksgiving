...
/**
 * Script to upload menu images from public/images to PRODUCTION S3
 * 
 * This script:
 * 1. Reads all menu files from public/images/
...
class ProductionMenuUploader {
  ...
  private localMenuPath: string = path.join(process.cwd(), 'public', 'images');
  ...
  async run(): Promise<void> {
    console.log('🚀 Starting menu upload from public/images to PRODUCTION S3...');
